...
currentItems[1] = EnsureNotSame(currentNums[0], currentNums[1], array_length(possibleInstructions))
currentItems[2] = EnsureNotSame(currentNums[0], currentNums[2], array_length(possibleInstructions))
currentItems[2] = EnsureNotSame(currentNums[1], currentNums[2], array_length(possibleInstructions))
